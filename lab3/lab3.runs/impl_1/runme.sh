...
HD_PWD='/home/ece385user/Documents/ece385/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_toplevel.tcl -notrace
