...
HD_PWD='/home/ece385user/Documents/ece385/lab4/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_toplevel.tcl
