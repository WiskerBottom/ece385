...
HD_PWD='/home/ece385user/Documents/ece385/lab4/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_toplevel.tcl -notrace
